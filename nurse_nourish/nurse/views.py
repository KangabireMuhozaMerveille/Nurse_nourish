...
from .forms import RegistrationForm, LoginForm, CommentForm, CompleteProfileForm
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if authenticated_user is not None:
                ...
                return redirect('nurse:complete')
        else:
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                return redirect('nurse:home')  # Adjust to your home URL pattern
            else:
...
def create_post(request):
    ...
    if request.method == 'POST':
        ...
        post.save()
        return redirect('nurse:profile')  # Adjust to your profile URL pattern
...
def add_comment(request, post_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            comment.post = post
            comment.save()
            return redirect('nurse:post_detail', post_id=post.id)  # Adjust to your post detail URL pattern
    else:
        form = CommentForm()
...
def send_message(request):
    if request.method == 'POST':
        ...
        if not content or not recipient_id:
            return redirect('nurse:inbox')  # Redirect back if form data is missing
        
        try:
            recipient = get_object_or_404(User, id=recipient_id)
        except User.DoesNotExist:
            return redirect('nurse:inbox')  # Redirect back if recipient does not exist
        ...
        return redirect('nurse:inbox')  # Redirect back to inbox or another appropriate page

    return redirect('nurse:inbox')
...
def delete_post(request, post_id):
    ...
    if request.method == 'POST':
        ...
        return redirect('nurse:profile')  # Redirect to a suitable page
